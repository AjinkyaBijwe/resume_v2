...
const CVSidebar = ({ activeSection, onSectionClick }: CVSidebarProps) => {
  ...
  return (
    <>
      ...
      <div className="sticky top-0 z-10 md:hidden bg-white/90 backdrop-blur-sm border-b border-gray-200 w-full">
        ...
        <div className="flex overflow-x-auto py-2 px-4 bg-white/80 backdrop-blur-sm shadow-sm">
          {menuItems.map(item => (
            <button
              key={item.id}
      ...
      <aside className="hidden md:flex fixed left-8 top-8 z-20 h-auto bg-white/90 backdrop-blur-sm rounded-xl border border-gray-200 shadow-lg">
        <div className="flex flex-col w-64">
          <div className="flex items-center justify-center md:justify-start p-6 mb-2">
